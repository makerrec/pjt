        ...
        <form action="<?php echo $path; ?>/repositorio/curso/salvarCurso.php" method="POST">
            <div class="row mb-3">
                ...
                <div class="col col-md-4">
                    ...
                    <input class="form-control" type="number" name="ntc" id="idntc">
                </div>
                <div class="col col-md-6">
                    <label class="form-label" for="idntc">Área</label>
                    <input class="form-control" type="text" name="nome" id="idntc">
                </div>
                <div class="col col-md-6">
                    <label class="form-label" for="idntc">Campus</label>
                    <input class="form-control" type="text" name="ntc" id="idntc">
                </div>
